...
<picture>
  ...
  <img alt="Damien Duboeuf — software architect, backend and front-end" src="./assets/banner-light.svg?v=3" width="100%">
</picture>
...
<p align="center">
  <b>Software architect</b> — backend and front-end.<br>
  Symfony and NestJS on one side, Vue, React and Angular on the other, and the C++ firmware at the far end of the house.<br>
  I design the shape of a system, then build it: bundles that do one job well,<br>
  apps that ship as a single Docker image, and a home that talks over MQTT.<br>
...
<a href="https://smea.tech/">
  <picture>
    ...
    <img alt="Latest posts on smea.tech" src="./assets/blog-light.svg?v=3" width="100%">
  </picture>
</a>
...
<picture>
  ...
  <img alt="Public GitHub statistics for Smeagolworms4" src="./assets/pulse-light.svg?v=3" width="100%">
</picture>
